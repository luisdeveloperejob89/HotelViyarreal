...
{        
     ...
     */
    public FrmListaPaquetes(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Paquetes disponibles"));
    ...
    public void AsignaDatos()
    {
        ...
        if ( tblClientes != null )
        {        
            iIdPaquete = Integer.parseInt(tblClientes.getValueAt(tblClientes.getSelectedRow(), 0).toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmListaPaquetes dialog = new FrmListaPaquetes(new javax.swing.JFrame(), true);
