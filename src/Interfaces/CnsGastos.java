 ...
 * @author Usuario
 */
public class CnsGastos extends javax.swing.JInternalFrame
{    
    ...
    public void AjustaColumnas()
    {
        ...
        tblModeloColumnas.getColumn(1).setPreferredWidth(90);
    ...
    {                        
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));        
        gGastos.DameRegistrosGastos(dtmTabla, GetColumnas());        
        this.setCursor(Cursor.getDefaultCursor());
    }
    
    public String[] GetColumnas()
    {                
        String strColumnas[] = new String[]{"Id"/*0*/, "Concepto"/*1*/, "Nombre"/*2*/, "Total"/*3*/, "Fecha"/*4*/, "Hora"/*5*/};
    ...
    {
        FrmDlgDetGastos frm = null;
        
        frm = new FrmDlgDetGastos(null, true, iID);
        frm.show();
        RefrescarForma();
    }
